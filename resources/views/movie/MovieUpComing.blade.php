...
<html lang="en" data-bs-theme="auto">
  ...
  <body>  
    ...
    <div class="album py-3" style="background-color: rgb(16, 16, 16)">
      <div class="container">
        <h5 class="pb-2" style="color: white">Upcoming Movies</h5>
        <div class="row">
          @foreach ($MovieUpcoming as $MovieUpcoming)
          <div class="item movie-card-detal col-md-2 col-6" style="margin-top: 15px;">
            <a href="{{ route('tv.show', ['id' => $MovieUpcoming['id'], 'seasonNumber' => '1']) }}" class="non-text-decoration">
              <img src="{{ 'https://image.tmdb.org/t/p/w500'. $MovieUpcoming['poster_path'] }}" class="img-fluid" alt="gambar">
              <div class="py-2 movie-details-detal">
                <p class="daleman-p-poster-detal col-3">
                  <i class="fa-solid fa-star" style="color: #d7a904;"></i> {{$MovieUpcoming['vote_average']}}
                </p>
                ...
                <p class="col-12 text-center" style="margin-top:30%;">{{ $MovieUpcoming['original_title'] }} ({{($MovieUpcoming['release_date'] )}})</p>
              </div>              
            </a>
          </div>
          @endforeach
